...
1. Proje içerisindeyken ilk olarak yapmanız gereken şey projeyi build etmektir. Böylelikle uygulamanın çalışması için gerekli olan <code>/target</code> klasörü oluşacaktır.
